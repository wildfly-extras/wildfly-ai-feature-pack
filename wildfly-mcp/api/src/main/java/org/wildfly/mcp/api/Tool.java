 ...
 *
 * <ul>
 * <li>If the method returns {@link String} then the response is {@code success} and contains the single {@link TextContent}
 * object.</li>
 * <li>If the method returns an implementation of {@link Content} then the response is {@code success} and contains the single
 * content object.</li>
 * <li>If the method returns a {@link List} of {@link Content} implementations or {@link String}s then the response is
