...
public class MCPDualVersionIntegrationTestCase extends AbstractMCPIntegrationTestCase {
    ...
    @Test
    void testModernProtocolVersionHeaderAccepted() throws Exception {
        ...
        assertThat(statusCode).as("MCP-Protocol-Version 2026-07-28 should be accepted at HTTP level").isEqualTo(200);
