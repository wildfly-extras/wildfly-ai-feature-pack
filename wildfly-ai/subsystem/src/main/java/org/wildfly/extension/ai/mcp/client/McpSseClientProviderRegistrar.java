...
public class McpSseClientProviderRegistrar implements ChildResourceDefinitionRegistrar {
    ...
    static final String NAME = "mcp-sse-client";
    public static final PathElement PATH = PathElement.pathElement(NAME);

    public McpSseClientProviderRegistrar(ParentResourceDescriptionResolver parentResolver) {
        this.registration = ResourceRegistration.of(PATH);
        this.descriptor = ResourceDescriptor.builder(parentResolver.createChildResolver(PATH))
                .addCapability(MCP_CLIENT_CAPABILITY)
                .addAttributes(ATTRIBUTES)
                .withRuntimeHandler(ResourceOperationRuntimeHandler.configureService(new McpSseClientServiceConfigurator()))
                .build();
    }
