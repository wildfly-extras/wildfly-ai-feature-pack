...
import org.wildfly.extension.ai.mcp.client.McpSseClientProviderRegistrar;
import org.wildfly.extension.ai.mcp.client.McpStdioClientProviderRegistrar;
    ...
    public PersistentResourceXMLDescription getXMLDescription() {
        ...
        return factory.builder(AISubsystemRegistrar.PATH)
                ...
                .addChild(PersistentResourceXMLDescription.decorator("mcp")
                        ...
                        .addChild(factory.builder(McpSseClientProviderRegistrar.PATH).addAttributes(McpSseClientProviderRegistrar.ATTRIBUTES.stream()).build())
                        .addChild(factory.builder(McpStdioClientProviderRegistrar.PATH).addAttributes(McpStdioClientProviderRegistrar.ATTRIBUTES.stream()).build())
                        .build())
                .build();
    }
}
