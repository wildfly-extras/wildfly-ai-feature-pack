...
import static org.wildfly.extension.ai.mcp.client.McpCapabilities.MCP_CLIENT_CAPABILITY;
...
public class McpStdioClientProviderRegistrar implements ChildResourceDefinitionRegistrar {
    ...
    static final String NAME = "mcp-stdio-client";
    public static final PathElement PATH = PathElement.pathElement(NAME);

    public McpStdioClientProviderRegistrar(ParentResourceDescriptionResolver parentResolver) {
        this.registration = ResourceRegistration.of(PATH);
        this.descriptor = ResourceDescriptor.builder(parentResolver.createChildResolver(PATH))
                .addCapability(MCP_CLIENT_CAPABILITY)
                .addAttributes(ATTRIBUTES)
                .withRuntimeHandler(ResourceOperationRuntimeHandler.configureService(new McpStdioClientProviderServiceConfigurator()))
                .build();
    }
